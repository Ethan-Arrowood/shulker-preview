...
execute if data storage ethan-arrowood.shulker_preview:data item.components."minecraft:potion_contents".potion run data modify storage ethan-arrowood.shulker_preview:data item.components."minecraft:potion_contents".custom_effects append value {}
execute if data storage ethan-arrowood.shulker_preview:data item.components."minecraft:potion_contents".potion run data modify storage ethan-arrowood.shulker_preview:data item.components."minecraft:potion_contents".custom_effects[-1].id set from storage ethan-arrowood.shulker_preview:data item.components."minecraft:potion_contents".potion
