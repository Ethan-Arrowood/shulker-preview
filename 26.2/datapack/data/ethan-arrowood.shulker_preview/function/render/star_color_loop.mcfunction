...
execute store result score #color shulker_preview run data get storage ethan-arrowood.shulker_preview:data item.components."minecraft:firework_explosion".colors[-1]
...
data remove storage ethan-arrowood.shulker_preview:data item.components."minecraft:firework_explosion".colors[-1]
execute if data storage ethan-arrowood.shulker_preview:data item.components."minecraft:firework_explosion".colors[0] run function ethan-arrowood.shulker_preview:render/star_color_loop
