...
execute store result score #boxes shulker_preview run clear @s #ethan-arrowood.shulker_preview:shulker_boxes[!custom_data~{"shulker_preview.processed":1b},container~{items:{size:{min:1}}}] 0
execute if score #boxes shulker_preview matches 1.. run function ethan-arrowood.shulker_preview:shulker_box/process
