...
execute if items entity @s contents #ethan-arrowood.shulker_preview:shulker_boxes[container~{items:{size:{min:1}}}] run function ethan-arrowood.shulker_preview:shulker_box/process_dropped
