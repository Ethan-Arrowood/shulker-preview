...
def main():
   ...
   for row in range(0, 3):
      ...
      special_render.append(f'execute if items entity @s contents #minecraft:cauldron_can_remove_dye run return run function tryashtar.shulker_preview:render/row_{row}/special_render/dyeable1')
      for kind,items in colorable_items.items():
         if len(items) == 1:
