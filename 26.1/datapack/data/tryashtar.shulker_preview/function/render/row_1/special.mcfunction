...
execute if items entity @s contents #minecraft:cauldron_can_remove_dye run return run function tryashtar.shulker_preview:render/row_1/special_render/dyeable1
